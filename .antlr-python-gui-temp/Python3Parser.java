...
public class Python3Parser extends Parser {
	...
	public final File_inputContext file_input() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2337377001937893336L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 32867L) != 0)) {
				{
				setState(181);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final DecoratorContext decorator() throws RecognitionException {
		...
		try {
			...
			if (_la==OPEN_PAREN) {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2913834464285032472L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 99L) != 0)) {
					{
					setState(200);
					arglist();
					}
	...
	public final ParametersContext parameters() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 585472349604675584L) != 0)) {
				{
				setState(233);
				typedargslist();
				}
	...
	public final AugassignContext augassign() throws RecognitionException {
		...
		try {
			...
			setState(480);
			_la = _input.LA(1);
			if ( !(((((_la - 85)) & ~0x3f) == 0 && ((1L << (_la - 85)) & 8191L) != 0)) ) {
	...
	public final Return_stmtContext return_stmt() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2328366512726867992L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 99L) != 0)) {
				{
				setState(499);
				testlist();
				}
		...
		try {
			...
			case NEWLINE:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 2337374802914637784L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 32867L) != 0) );
				setState(719);
				match(DEDENT);
				}
				break;
	...
	public final ComparisonContext comparison() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 20)) & ~0x3f) == 0 && ((1L << (_la - 20)) & 9151314442816848641L) != 0)) {
				{
				{
				setState(774);
				comp_op();
	...
	public final TermContext term() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 53)) & ~0x3f) == 0 && ((1L << (_la - 53)) & 1074659329L) != 0)) {
				{
				{
				setState(841);
				_la = _input.LA(1);
				if ( !(((((_la - 53)) & ~0x3f) == 0 && ((1L << (_la - 53)) & 1074659329L) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final Atom_exprContext atom_expr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2326109207536861184L) != 0)) {
				{
				{
				setState(862);
				trailer();
	...
	public final AtomContext atom() throws RecognitionException {
		...
		try {
			...
			case OPEN_BRACK:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2337373711981608984L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 99L) != 0)) {
					{
					setState(875);
					testlist_comp();
					}
	...
	public final Comp_forContext comp_for() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 549756370944L) != 0)) {
				{
				setState(1084);
				comp_iter();
				}
	...
	public final Yield_exprContext yield_expr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2328366512726868504L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 99L) != 0)) {
				{
				setState(1095);
				yield_arg();
				}
